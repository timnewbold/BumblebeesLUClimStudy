...
Individual model chains converged well (all Rhat &le; `r max.rhat`; Figure S4). There was a good correspondence between model posterior predicted values and observations (Figure S5). A Moran's test across all of the model residuals did not reveal significant spatial autocorrelation (I = `r moran.i`; P = `r moran.p`). However, there was significant spatial autocorrelation (P < 0.05) in the residuals associated with 13.6% of the underlying studies in the dataset, higher than the 5% expected by chance (Figure S6). Importantly, the records from studies with significant residual spatial autocorrelation did not occupy extreme positions along the range of any of the explanatory variables (Figure S3), and so bias in coefficient estimates is unlikely. Results were very similar when the landscape availability of natural habitat was estimated at 1-km or 5-km instead of 2-km spatial grain (Figures S7 & S8), and when using high instead of low estimates of cumulative pesticide toxicity (Figure S11). Estimates of the effect of duration of substantial habitat modification were weaker (although qualitatively unchanged) when substantial habitat modification was defined using a threshold of 10% or 50% conversion of landscapes to human-dominated land uses, rather than the 30% threshold used in the main text (Figures S9 & S10). Results were also robust when fitting a zero-inflated negative binomial model of relative abundance instead of a binomial model of presence/absence, the key differences being that effects of natural habitat were somewhat weaker, and effects of pesticide toxicity stronger (Figure S12).
