...
```{r figforest, echo=FALSE, warning=FALSE, fig.width=17.5/2.54, fig.height=12/2.54,out.width="100%", fig.cap="**Forest plot of coefficient estimates from the full binomial Bayesian hierarchical model relating bumblebee occurrence to land use, landscape habitat, pesticide toxicity and thermal niche properties**"}
