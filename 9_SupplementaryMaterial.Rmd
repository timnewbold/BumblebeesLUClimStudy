...
```{r, echo=FALSE,warning=FALSE,results=FALSE,fig.width=16.5/2.54,fig.height=12/2.54,out.width="100%",dpi=1200,fig.cap="**Representation of species with different threat statuses in the model**. For European bumble bee species, for which all species have been assigned a Red List status (https://portals.iucn.org/library/sites/library/files/documents/RL-4-019.pdf), the distribution of sampled (Data = Yes) and unsampled species (Data = No) among different levels of extinction risk (LC = Least Concern, NT = Near Threatened, VU = Vulnerable, EN = Endangered, CR = Critically Endangered, DD = Data Deficient). Reveals a bias in sampling towards species with lower levels of assessed extinction risk."}
