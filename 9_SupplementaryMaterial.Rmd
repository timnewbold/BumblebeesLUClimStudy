...
histNatHab <- ggplot() + geom_histogram(data = modelData,mapping = aes(x = NaturalHabitat2k/10),bins=10) + scale_x_continuous(name = "Natural Habitat (%)") + scale_y_continuous(name = "Frequency") + theme(axis.title = element_text(size = 12),axis.text = element_text(size = 10)) + theme_classic()

histAge <- ggplot() + geom_histogram(data = modelData,mapping = aes(x = AgeConv),bins=10) + scale_x_continuous(name = "Duration of landscape conversion (yrs)") + scale_y_continuous(name = "Frequency") + theme(axis.title = element_text(size = 12),axis.text = element_text(size = 10)) + theme_classic()

histPest <- ggplot() + geom_histogram(data = modelData,mapping = aes(x = exp(LogPestToxLow)-1)) + scale_x_continuous(name = "Pesticide toxicity") + scale_y_continuous(name = "Frequency") + theme(axis.title = element_text(size = 12),axis.text = element_text(size = 10)) + theme_classic()

histTEIBL <- ggplot() + geom_histogram(data = modelData,mapping = aes(x = TEI_BL),bins=10) + scale_x_continuous(name = "Baseline thermal position") + scale_y_continuous(name = "Frequency") + theme(axis.title = element_text(size = 12),axis.text = element_text(size = 10)) + theme_classic()

histTEIDelta <- ggplot() + geom_histogram(data = modelData,mapping = aes(x = TEI_delta),bins=10) + scale_x_continuous(name = "\u0394 thermal position") + scale_y_continuous(name = "Frequency") + theme(axis.title = element_text(size = 12),axis.text = element_text(size = 10)) + theme_classic()
